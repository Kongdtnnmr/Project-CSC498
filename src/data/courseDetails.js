    ...
    pws: {
        0: { // Mechanical Technology
            ...
            TH: {
                ...
                careers: [
                    "วิศวกรยานยนต์ในโรงงาน",
                    "วิศวกรควบคุมคุณภาพผลิตภัณฑ์",
                    "วิศวกรควบคุมหรือซ่อมบำรุงเครื่องจักรในอุตสาหกรรมยานยนต์",
                    "วิศวกรออกแบบทดสอบยานยนต์",
                    "วิศวกรควบคุมการติดตั้งระบบ",
                    "วิศวกรฝ่ายขายหรือบริการด้านเทคนิคในอุตสาหกรรมยานยนต์",
                    "วิศวกรทีมแข่งหรือฝ่ายการแข่งขันยานยนต์",
                    "อาจารย์ / นักวิชาการและนักวิจัยด้านวิศวกรรมยานยนต์",
                    "ผู้ประกอบการอุตสาหกรรมบริการยานยนต์"
                ],
                education: [
                    { level: "แนวทางการศึกษาต่อ", items: ["วิศวกรรมเครื่องกล", "อุตสาหกรรมศิลป์เครื่องกล", "วิศวกรรมยานยนต์", "เครื่องกลเกษตร"] }
                ]
            },
            EN: {
                ...
                careers: [
                    "Automotive engineers in factories. Production Engineer Product Quality Control Engineer",
                    "Control or Maintenance Engineer for Machinery in Automotive Industry",
                    "Engineer for Automotive Design Test",
                    "Engineer for System Installation Control",
                    "Sales or Service Engineer Technical in the automotive industry",
                    "Engineer, race team or the automotive competition department",
                    "Lecturer / Academic and Researcher in Automotive Engineering",
                    "Automotive Service Industry Entrepreneur"
                ],
                education: [
                    { level: "Study guidelines", items: ["Mechanical engineering", "Mechanical education industry", "Automotive engineering", "Agricultural mechanics"] }
                ]
            }
        },
        1: { // Electrical Power
            ...
            TH: {
                ...
                careers: [
                    "การไฟฟ้าส่วนภูมิภาค การไฟฟ้านครหลวง การไฟฟ้าฝ่ายผลิตแห่งประเทศไทย",
                    "ช่างเทคนิค CAT Telecom, TOT เครือข่ายโทรศัพท์มือถือ",
                    "ช่างซ่อมคอมพิวเตอร์ ฮาร์ดแวร์ ซอฟต์แวร์ ไอที อินเทอร์เน็ต",
                    "ช่างเทคนิค บริษัทควบคุมระบบการผลิตสินค้าในโรงงานอุตสาหกรรม",
                    "ช่างเทคนิคศูนย์เทคโนโลยีอิเล็กทรอนิกส์",
                    "บริษัทเอกชนที่ผลิตเกี่ยวกับสายงานนี้",
                    "ช่างไฟฟ้าทั้งภายในและภายนอกอาคาร",
                    "ช่างซ่อมบำรุงทั่วไปในโรงงาน",
                    "หัวหน้าแผนกการผลิตต่างๆ",
                    "ช่างเทคนิคหรือวิศวกรเขียนแบบโครงสร้างไฟฟ้าอาคาร"
                ],
                education: [
                    { level: "แนวทางการศึกษาต่อ", items: ["สาขาไฟฟ้า", "สาขาอิเล็กทรอนิกส์", "สาขาเมคคาทรอนิกส์และหุ่นยนต์", "สาขาไฟฟ้าสื่อสารและโทรคมนาคม", "สาขาอุตสาหการ", "สาขาระบบควบคุมและเครื่องมือวัด", "สาขาคอมพิวเตอร์"] }
                ]
            },
            EN: {
                ...
                careers: [
                    "Provincial Electricity Authority, Metropolitan Electricity Authority Electricity Generating Authority of Thailand",
                    "Technicians for CAT Telecom, TOT mobile phone networks",
                    "Mechanics attached to computers, hardware, software, IT, Internet",
                    "Technicians, companies that are working on production control systems Products in industrial plants",
                    "Technicians at the Electronic Technology Center",
                    "Private companies that produce about this field",
                    "Electrical technician both inside and outside the building",
                    "General maintenance technician in the factory",
                    "The heads of various production departments",
                    "Technicians or engineers to draw electrical structure of the building",
                    "The department heads of workers"
                ],
                education: [
                    { level: "Further study guidelines", items: ["Electrical Program", "Electronic electronics Program", "Mechatronic and Robotics Program", "Electrical Communication and Telecommunication Program", "Industrial Program", "Control System and Measuring Instruments Electrical and Computer Program", "Computer Program"] }
                ]
            }
        },
        2: { // Industrial Techniques (Manufacturing)
            scheduleImage: "/pic/pic ปวส/pws_ind_tech.webp",
            TH: {
                title: "สาขาวิชาเทคนิคอุตสาหกรรม",
                description: "การออกแบบและเขียนแบบด้วยคอมพิวเตอร์ การประยุกต์ใช้คอมพิวเตอร์และเทคโนโลยีสารสนเทศ การผลิตและตรวจสอบชิ้นส่วนเครื่องกล การตรวจสอบและบำรุงรักษาเครื่องมือกล การประมาณราคาแงานบำรุงรักษา อุตสาหกรรมการผลิต การวางแผนการจัดการความปลอดภัย การเขียนโปรแกรมรหัสควบคุม CNC งานนิวเมติกส์และไฮดรอลิกส์",
                careers: [
                    "การออกแบบและควบคุมเครื่องจักร CNC",
                    "งานเขียนแบบและออกแบบ",
                    "การควบคุมนิวเมติกส์และไฮดรอลิกส์",
                    "การวัดละเอียดและตรวจสอบคุณสมบัติวัสดุ",
                    "งานซ่อมบำรุงเครื่องจักร",
                    "สุขศาสตร์อุตสาหกรรม",
                    "การผลิตชิ้นส่วนยานยนต์และชิ้นส่วนเครื่องจักรกล"
                ],
                education: [
                    { level: "แนวทางการศึกษาต่อ", items: ["เทคโนโลยีอุตสาหกรรม", "วิศวกรรมการผลิตและอุตสาหการ", "วิศวกรรมการผลิต"] }
                ]
            },
            EN: {
                title: "High Vocational Course in Manufacturing Industry : lndustrial Production Program",
                description: "Computer design and drawing Application of computer and information technology Production and inspection of mechanical parts Inspection and maintenance of machine tools Estimation of maintenance work Manufacturing industry Safety management planning CNC control code programming Pneumatic and hydraulic work",
                careers: [
                    "CNC machine design and control",
                    "Drawing and design work",
                    "Pneumatic and hydraulic control",
                    "Detailed measuring and material properties checking",
                    "Maintenance work Machinery",
                    "Occupational Sanitation",
                    "Production of Automobile Parts and Machinery Parts"
                ],
                education: [
                    { level: "Study guidelines", items: ["Industrial Technology", "Program - Production Engineering and Industrial", "Program - Production Engineering Program"] }
                ]
            }
        },
        3: { // Industrial Electronics (NEW ITEM - will be inserted at index 3)
            ...
            TH: {
                ...
                careers: [
                    "ช่างอิเล็กทรอนิกส์",
                    "ช่างโทรศัพท์ ระบบโทรศัพท์ โปรแกรม PABX",
                    "ซ่อมและโปรแกรมโทรศัพท์มือถือ",
                    "ช่างติดตั้ง บำรุงรักษา และโปรแกรมจานดาวเทียม",
                    "ช่างระบบเสียง ติดตั้งและปรับแต่งเสียง (Mix)",
                    "งานคอมพิวเตอร์",
                    "เครือข่ายคอมพิวเตอร์",
                    "การเขียนโปรแกรมไมโครคอนโทรลเลอร์",
                    "การออกแบบแผ่นวงจรพิมพ์",
                    "งานติดตั้งระบบเสาอากาศวิทยุและโทรทัศน์",
                    "ออกแบบผลิตภัณฑ์อิเล็กทรอนิกส์",
                    "จำหน่ายอุปกรณ์ไฟฟ้าและอิเล็กทรอนิกส์"
                ],
                education: [
                    { level: "แนวทางการศึกษาต่อ (ปริญญาตรี)", items: ["วิศวกรรมอิเล็กทรอนิกส์", "วิศวกรรมโทรคมนาคม", "วิศวกรรมไฟฟ้า", "วิศวกรรมเมคคาทรอนิกส์", "วิศวกรรมอุตสาหการ", "วิศวกรรมอิเล็กทรอนิกส์และโทรคมนาคม", "วิศวกรรมเครือข่ายและอินเทอร์เน็ต", "เทคโนโลยีเครื่องจักรกลเกษตร"] }
                ]
            },
            EN: {
                ...
                careers: [
                    ...
                    "Telephone technician, Telephone system, PABX program",
                    "Mobile phone fixing and program such as Logo, Ring Tone, Video Clip etc.",
                    "Technicians installing, maintenance and programs satellite dishes",
                    "Sound system technician install and adjust sound system (Mix)",
                    "Computer work",
                    "Computer networks",
                    "Microcontroller programming eg. Light circuit, robot program",
                    "Printed circuit board design",
                    "Installation of aerial and television antenna systems",
                    "Electronic product design",
                    "Distribution of electrical and electronic equipment"
                ],
                education: [
                    { level: "Further Education (Bachelor Degree)", items: ["Electronics Engineering", "Telecommunication Engineering", "Electrical Engineering", "Mechatronic Engineering", "Industrial Engineering", "Electronics and Telecommunication Engineering", "Network and Internet Engineering", "Agricultural Machinery Technology"] }
                ]
            }
        },
        ...
        5: {
            ...
            TH: {
                ...
                careers: [
                    "ช่างเทคนิคควบคุมระบบเครื่องกลและหุ่นยนต์อุตสาหกรรม",
                    "ช่างเทคนิค เขียนแบบและโปรแกรม ระบบควบคุมอัตโนมัติและหุ่นยนต์อุตสาหกรรม",
                    "ช่างเทคนิค ออกแบบ ติดตั้ง และบำรุงรักษาระบบอุตสาหกรรม",
                    "ผู้ช่วยวิศวกรเครื่องกล",
                    "ผู้รับเหมาติดตั้งเครื่องจักรและระบบควบคุมอัตโนมัติ",
                    "ช่างเทคนิคในโรงงานและอาคารพาณิชย์",
                    "ช่างเทคนิคศูนย์บริการ",
                    "ผู้ตรวจสอบคุณภาพผลิตภัณฑ์"
                ],
                education: [
                    { level: "แนวทางการศึกษาต่อ (ปริญญาตรี)", items: ["วิศวกรรมเมคคาทรอนิกส์", "วิศวกรรมหุ่นยนต์", "วิศวกรรมระบบควบคุมอัตโนมัติ", "วิศวกรรมอากาศยาน"] }
                ]
            },
            EN: {
                ...
                careers: [
                    "Technicians to control mechanical systems and industrial robots",
                    "Technician, drawing and programming, automatic control system and industrial robot",
                    "Technician, design, system installation and maintenance of industrial systems",
                    "Assistant Engineer, Mechanics",
                    "The contractor of the installation of machinery and automatic control systems",
                    "Technicians in factories and commercial buildings.",
                    "Technician at service center - Product Quality Inspector"
                ],
                education: [
                    { level: "Further Education (Bachelor Degree)", items: ["Mechatronics Engineering", "Robotic Engineering", "Automatic Control System Engineering", "Aircraft Engineering"] }
                ]
            }
        },
        ...
        6: {
            ...
            TH: {
                ...
                careers: [
                    ...
                    "นักบัญชีในองค์กรต่างๆ",
                    "พนักงานบริษัทเอกชน",
                    "ลูกจ้างหน่วยงานภาครัฐและรัฐวิสาหกิจ"
                ],
                education: [
                    { level: "แนวทางการศึกษาต่อ (ปริญญาตรี)", items: ["การบัญชี", "การตลาด", "การจัดการโลจิสติกส์", "การจัดการอุตสาหกรรม", "การบริหารและการจัดการสมัยใหม่", "ธุรกิจระหว่างประเทศ", "การเงินการธนาคาร", "การจัดการทรัพยากรมนุษย์", "การเป็นเจ้าของธุรกิจ"] }
                ]
            },
            EN: {
                ...
                careers: [
                    "Audit office staff",
                    "Accountant in various organizations",
                    "Employees of private companies",
                    "Employees of government and state enterprises"
                ],
                education: [
                    { level: "Further Education (Bachelor Degree)", items: ["Accounting", "Market", "Logistics Management", "Industrial Management", "Modern Administration and Management", "International Business", "Banking", "Human Resource Management", "Business Ownership"] }
                ]
            }
        },
        ...
        7: {
            ...
            EN: {
                ...
                education: [{ level: "Bachelor Degree", items: ["Digital Business Management", "International Business", "Modern Administration and Management", "Digital Marketing", "Business Administration", "Organization and Human Resources Management", "Economics", "Logistics Management", "General Management"] }]
            }
        },
        ...
        8: {
            ...
            EN: {
                ...
                education: [{ level: "Further Education (Bachelor Degree)", items: ["Logistics Management", "Management", "Business Administratio"] }]
            }
        },
        ...
        9: {
            ...
            EN: {
                ...
                education: [{ level: "Further Education", items: ["Digital Media", "Information Technology", "Game and Interactive Media", "Computer Engineering", "Animation and Multimedia", "Graphic Design"] }]
            }
        },
        ...
        10: {
            ...
            EN: {
                ...
                education: [{ level: "Further Education", items: ["Multimedia", "Film and Digital Media", "Communication Innovation", "Social Communication Innovation", "Digital Art", "Computer Animation and Visual Effects", "Interactive and Game Design", "Graphic Design", "Digital Communication Design"] }]
            }
        },
        // Old Index 10 -> New Index 11: Business Computer (Wait, business computer is PVC. IT is PWS. Business Computer is not in PWS list)
        // Check PWS list in translations.js again:
        // [Mech, Elec, IndTech, Sports, Mecha, Acc, Mkt, Logis, IT, Multi, Health, EV]
        // My indices above:
        // 0: Mech
        // 1: Elec
        // 2: IndTech
        // 3: Ind Electronics (NEW)
        // 4: Sports
        // 5: Mecha
        // 6: Acc
        // 7: Mkt
    ...
    pvc: {
        0: {
            ...
            TH: {
                ...
                education: [
                    { level: "ระดับ ปวส.", items: ["สาขางานเทคนิคยานยนต์", "สาขางานเทคนิคเครื่องกลระบบขนส่งทางราง", "สาขางานเทคนิคเครื่องกลอุตสาหกรรม", "สาขางานเทคนิคเครื่องกลการเกษตร", "สาขางานเทคนิคซ่อมตัวถังและสีรถยนต์"] },
                    { level: "ระดับ ปริญญาตรี", items: ["สาขาวิศวกรรมยานยนต์", "สาขาวิศวกรรมเครื่องกล", "สาขาวิศวกรรมเครื่องกลเกษตร", "สาขาครุศาสตร์เครื่องกล"] }
                ]
            },
            EN: { // Keeping simple EN if not provided, or inferring titles from user header
                ...
                education: [
                    { level: "High Vocational Certificate", items: ["Automotive Techniques", "Rail Transport Systems", "Industrial Mechanics", "Agricultural Mechanics", "Body and Paint"] },
                    { level: "Bachelor's Degree", items: ["Automotive Engineering", "Mechanical Engineering", "Agricultural Machinery Engineering", "Mechanical Education"] }
                ]
            }
        },
        1: {
            ...
            TH: {
                ...
                education: [
                    { level: "ระดับ ปวส.", items: ["สาขาไฟฟ้า", "สาขาไฟฟ้าและอิเล็กทรอนิกส์", "สาขาแมคคาทรอนิกส์และหุ่นยนต์", "สาขาไฟฟ้าสื่อสารและโทรคมนาคม", "สาขาอุตสาหการ", "สาขาระบบควบคุมและเครื่องมือวัด", "สาขาเทคนิคคอมพิวเตอร์"] },
                    { level: "ระดับ ปริญญาตรี", items: ["สาขาวิศวกรรมไฟฟ้า", "สาขาเทคโนโลยีไฟฟ้าอุตสาหกรรม"] }
                ]
            },
            EN: {
                ...
                education: [
                    { level: "High Vocational Certificate", items: ["Electrical Power", "Electronics", "Mechatronics", "Telecommunications", "Industrial", "Control Systems", "Computer Techniques"] },
                    { level: "Bachelor's Degree", items: ["Electrical Engineering", "Industrial Electrical Technology"] }
                ]
            }
        },
        2: {
            ...
            TH: {
                ...
                education: [
                    { level: "ระดับ ปวส.", items: ["สาขาวิชาอิเล็กทรอนิกส์อุตสาหกรรม", "สาขาวิชาไฟฟ้า (ไฟฟ้าและอิเล็กทรอนิกส์/การวัดและควบคุม)", "สาขาวิชาเครื่องมือวัดและควบคุมในอุตสาหกรรม"] },
                    { level: "ระดับ ปริญญาตรี", items: ["หลักสูตรอุตสาหกรรมศาสตร์บัณฑิต สาขาวิชาเทคโนโลยีไฟฟ้าอุตสาหกรรม", "วิศวกรรมระบบเครื่องมือวัด", "วิศวกรรมอิเล็กทรอนิกส์", "วิศวกรรมไฟฟ้า", "วิศวกรรมโทรคมนาคม", "วิศวกรรมคอมพิวเตอร์"] }
                ]
            },
            EN: {
                ...
                education: [
                    { level: "High Vocational Certificate", items: ["Industrial Electronics", "Electrical Power", "Instrumentation and Control"] },
                    { level: "Bachelor's Degree", items: ["Industrial Electrical Technology", "Instrumentation Engineering", "Electronics Engineering", "Electrical Engineering", "Telecommunications", "Computer Engineering"] }
                ]
            }
        },
        3: {
            ...
            TH: {
                ...
                education: [
                    { level: "ระดับ ปวส.", items: ["สาขาวิชาเมคคาทรอนิกส์และหุ่นยนต์"] },
                    { level: "ระดับ ปริญญาตรี", items: ["วิศวกรรมเมคคาทรอนิกส์", "วิศวกรรมหุ่นยนต์", "วิศวกรรมเมคคาทรอนิกส์และระบบผลิตอัตโนมัติ", "ครุศาสตร์อุตสาหกรรม"] }
                ]
            },
            EN: {
                departmentName: "Industry Type: Mechatronics and Robotics Program (Mechatronics, Robotics and Automation Career Group)",
                ...
                education: [
                    { level: "High Vocational Certificate", items: ["Mechatronics and Robotics"] },
                    { level: "Bachelor's Degree", items: ["Mechatronics Engineering", "Robotics Engineering", "Automation Engineering", "Industrial Education"] }
                ]
            }
        },
        4: {
            ...
            TH: {
                ...
                education: [
                    { level: "ระดับ ปวส.", items: ["สาขาวิชาการบัญชี", "สาขาวิชาการตลาด", "สาขาวิชาการจัดการโลจิสติกส์และซัพพลายเชน", "สาขาวิชาธุรกิจสถานพยาบาล", "สาขาวิชาการเลขานุการ", "สาขาวิชาธุรกิจการค้าระหว่างประเทศ", "สาขาวิชาการจัดการธุรกิจค้าปลีก"] },
                    { level: "ระดับ ปริญญาตรี", items: ["สาขาวิชาการบัญชี", "สาขาวิชาการตลาด", "การจัดการโลจิสติกส์", "การบริหารและการจัดการสมัยใหม่", "ธุรกิจระหว่างประเทศ", "การเงินธนาคาร", "การบริหารทรัพยากรมนุษย์"] }
                ]
            },
            EN: {
                departmentName: "Business Administration Type: Accounting Program (Finance and Accounting Career Group)",
                ...
                education: [
                    { level: "High Vocational Certificate", items: ["Accounting", "Marketing", "Logistics", "Healthcare Business", "Secretary", "International Business", "Retail Management"] },
                    { level: "Bachelor's Degree", items: ["Accounting", "Marketing", "Logistics Management", "Modern Management", "International Business", "Banking", "Human Resources"] }
                ]
            }
        },
        5: {
            ...
            EN: {
                ...
                education: [
                    { level: "Study guidelines", items: ["Digital Business Management Program", "International Business Program", "Department of Modern Management and Management", "Program of Digital Marketing", "Program of Business Administration", "Program of Organization Management and Human Resources", "Department of Economics", "Logistics Management", "Department of General Management"] }
                ]
            }
        },
        6: {
            ...
            EN: {
                ...
                education: [
                    { level: "Further study", items: ["Computer Science", "Information Technology", "Game and Interactive Media", "Medical Information (Medical Informatics)", "Business Computer Program", "Computer Engineering Program", "Network Engineering and Security Program", "Animation and Multimedia Program", "Graphic Design Program"] }
                ]
            }
        },
        7: {
